    ...
    return (
      <>
          ...
          <div className="w-full max-w-6xl bg-white shadow-lg rounded-2xl p-6">
            <div className="flex flex-col gap-4 lg:flex-row lg:justify-between lg:items-center mb-6">
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                <button
                  onClick={() => this.setState({ addstatus: true })}
                  className="p-[12px_25px] bg-blue-400 text-white text-[20px] rounded-2xl"
                >
                  ADD
                </button>
              </div>
                    ...
                    <td>
                      <div className="flex gap-[10px] justify-center items-center flex-wrap">
                        <button
                          ...
                          className="p-[10px] bg-blue-500 rounded-2xl text-white"
                        >
                          Edit
                        </button>

                        <button
                          onClick={() => this.del(e.id)}
                          className="p-[10px] bg-red-500 rounded-2xl text-white"
                        >
                          Delete
                        </button>
                        ...
                        <Link
                          to={`/info/${e.id}`}
                          className="p-[10px] bg-black rounded-2xl text-white"
                        >
                          Info
                        </Link>
                      </div>
        ...
        >
          ...
          <DialogContent>
            <form onSubmit={this.addform} className="flex flex-col gap-3 p-3">
              <input
                name="name"
                placeholder="Name"
        ...
        >
          ...
          <DialogContent>
            <form onSubmit={this.editform} className="flex flex-col gap-3 p-3">
              <input
                name="name"
                placeholder="Name"
                className="border p-2 rounded"
